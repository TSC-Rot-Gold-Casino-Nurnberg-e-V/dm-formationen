  ...
  return (
    <header className="w-screen sticky top-0 bg-base-900/90">
      <nav className="container flex items-center justify-between max-sm:px-2">
        ...
        <Link
          href="/"
          className="block w-fit ml-2 bg-secondary-700 text-sm hover:bg-secondary-600 px-3 py-1 rounded-full transition-colors font-bold cursor-pointer !text-white"
        >
          Tickets sichern
        </Link>
