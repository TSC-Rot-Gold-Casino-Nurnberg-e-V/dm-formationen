...
// Flag zum Aktivieren/Deaktivieren der Presse-Seite.
// Setze PRESSE_ENABLED=true in der .env.local um die Seite freizuschalten.
const PRESSE_ENABLED = process.env.PRESSE_ENABLED === "true";

export const metadata: Metadata = {
  title: "Presse | Deutsche Meisterschaft der Formationen 2026",
  description:
    "Presseinformationen und Akkreditierung zur Deutschen Meisterschaft der Formationen 2026",
};
